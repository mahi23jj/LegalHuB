        ...
        try {
            const response = await axios.post(
                'https://api.mistral.ai/v1/chat/completions',
                {
                    ...
                    messages: [
                        { role: 'system', content: 'You are a legal expert providing definitions, explanations, and step-by-step application guides for legal terms.' },
                        { role: 'user', content: `Explain the legal term: "${term}" with examples, details, and provide step-by-step instructions to apply for the related document.` }
                    ],
                    max_tokens: 500,
                    temperature: 0.3
                },
            ...
            return res.status(200).json(new apiResponse(200, { term, response: responseText }, "Success"));
