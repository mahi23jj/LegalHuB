const sampleDocuments = [
    {
        ...
        description: "Application process for obtaining a PRC for tribal and non-tribal citizens in rural areas.",
        downloadLink: "https://drive.google.com/file/d/1b9UxqPQtAUF-JeWnrxZg6KENmLf-6Khb/view",
        applyLink: "https://sewasetu.assam.gov.in/site/service-apply/permanent-residential-certificate-prc-in-rural-areas-nchac",
        state: "Assam",
    ...
    },
    {
        ...
        description: "Application process for obtaining an income certificate for various purposes.",
        downloadLink: "https://sivasagar.assam.gov.in/sites/default/files/public_utility/INCOME.pdf",
        applyLink: "http://sewasetu.assam.gov.in/site/service-apply/application-for-income-certificate",
        state: "Assam",
        department: "Revenue & Disaster Management",
        guidelines: [
            "Register on the portal before applying.",
